!function (a) {
    ...
    var b, c = "function" == typeof define && define.amd, d = function (b) {
        ...
        var b = function (b) {
            ...
            if (0 === a.offset) {
                ...
                X(a.node) ? (d = a.node.childNodes[a.offset - 1], e = D(d)) : (d = a.node, e = c ? 0 : a.offset - 1);
            ...
            if (D(a.node) === a.offset) {
                ...
                X(a.node) ? (d = a.node.childNodes[a.offset], e = 0) : (d = a.node, e = c ? D(a.node) : a.offset + 1);
            return{node: d, offset: e}
        }, $ = function (a, b) {
            return a.node === b.node && a.offset === b.offset
        }, _ = function (a) {
            if (l(a.node) || !X(a.node) || E(a.node))
                return!0;
            ...
            if (l(a.node))
                return R(a) ? a.node : S(a) ? a.node.nextSibling : a.node.splitText(a.offset);
        ...
        var b = function (a, b) {
            ...
            this.isOnEditable = m(j.isEditable), this.isOnList = m(j.isList), this.isOnAnchor = m(j.isAnchor), this.isOnCell = m(j.isCell), this.isLeftEdgeOf = function (a) {
                ...
                if (j.isBodyContainer(b) && j.isEmpty(b))
                    return b.innerHTML = j.emptyPara, new d(b.firstChild, 0, b.firstChild, 0);
        ...
        this.stylePara = function (b, c) {
            ...
            if (b.isCollapsed())
                return b.insertNode(j.create(d));
        ...
        }, s = ["bold", "italic", "underline", "strikethrough", "superscript", "subscript", "justifyLeft", "justifyCenter", "justifyRight", "justifyFull", "formatBlock", "removeFormat", "backColor", "foreColor", "insertHorizontalRule", "fontName"], t = 0, u = s.length; u > t; t++)
            this[s[t]] = function (a) {
                return function (b, c) {
        ...
        this.tab = function (a, b) {
            ...
            m.createImage(b, c).then(function (b) {
                l(a), b.css({display: "", width: Math.min(a.width(), b.width())}), k.create().insertNode(b[0]), k.createFromNode(b[0]).collapse().select(), n(a)
            }).fail(function () {
        ...
        this.fontSize = function (a, b) {
            ...
            if (m) {
                ...
                o = b.styleNodes(j, {nodeName: "A", expandClosestSibling: !0, onlyPartialContains: !0});
    ...
    var z = function () {
        ...
        var p = function (b) {
            ...
            if (!b || !b.items || !b.items.length) {
                ...
                return h.saveNode(d), h.saveRange(d), d.html(""), void setTimeout(function () {
                    for (var a = d.find("img"), b = a[0].src, e = atob(b.split(",")[1]), f = new Uint8Array(e.length), g = 0; g < e.length; g++)
                        f[g] = e.charCodeAt(g);
            ...
            if (c.length) {
                ...
                if (j && c.parents(".popover").hide(), a.isFunction(a.summernote.pluginEvents[e]))
                    a.summernote.pluginEvents[e](b, h, l, f);
                else if (h[e]) {
                    var n = l.editable();
                    n.trigger("focus"), h[e](n, f, d), b.preventDefault()
                } else
                    r[e] && (r[e].call(this, l), b.preventDefault());
        ...
        this.bindKeyMap = function (b, c) {
            ...
            b = p(e), e.on("keydown", function (f) {
                ...
                if (j)
                    if (a.summernote.pluginEvents[j]) {
                        ...
                        h[j] ? (h[j](e, d.data("options")), f.preventDefault()) : r[j] && (r[j].call(this, b), f.preventDefault());
                else
            ...
            a.editable.data("callbacks", {onBeforeChange: b.onBeforeChange, onChange: b.onChange, onAutoSave: b.onAutoSave, onImageUpload: b.onImageUpload, onImageUploadError: b.onImageUploadError, onFileUpload: b.onFileUpload, onFileUploadError: b.onFileUpload, onMediaDelete: b.onMediaDelete})
        ...
        var b = function (a, b) {
            ...
            var b = [{kbd: "⌘ + B", text: a.font.bold}, {kbd: "⌘ + I", text: a.font.italic}, {kbd: "⌘ + U", text: a.font.underline}, {kbd: "⌘ + \\", text: a.font.clear}];
            return l(a.shortcut.textFormatting, b)
        }, n = function (a) {
            var b = [{kbd: "⌘ + Z", text: a.history.undo}, {kbd: "⌘ + ⇧ + Z", text: a.history.redo}, {kbd: "⌘ + ]", text: a.paragraph.indent}, {kbd: "⌘ + [", text: a.paragraph.outdent}, {kbd: "⌘ + ENTER", text: a.hr.insert}];
            return l(a.shortcut.action, b)
        }, o = function (a) {
            var b = [{kbd: "⌘ + ⇧ + L", text: a.paragraph.left}, {kbd: "⌘ + ⇧ + E", text: a.paragraph.center}, {kbd: "⌘ + ⇧ + R", text: a.paragraph.right}, {kbd: "⌘ + ⇧ + J", text: a.paragraph.justify}, {kbd: "⌘ + ⇧ + NUM7", text: a.lists.ordered}, {kbd: "⌘ + ⇧ + NUM8", text: a.lists.unordered}];
            return l(a.shortcut.paragraphFormatting, b)
        }, p = function (a) {
            var b = [{kbd: "⌘ + NUM0", text: a.style.normal}, {kbd: "⌘ + NUM1", text: a.style.h1}, {kbd: "⌘ + NUM2", text: a.style.h2}, {kbd: "⌘ + NUM3", text: a.style.h3}, {kbd: "⌘ + NUM4", text: a.style.h4}, {kbd: "⌘ + NUM5", text: a.style.h5}, {kbd: "⌘ + NUM6", text: a.style.h6}];
