...
(12, 'profil-adresa', 'Profil: Addresa', NULL, '1', 1, NULL, 1, NULL, NULL, NULL, NULL, 9, 17, 33, 0, 0),
(13, 'uspesne-prihlaseni', 'Profil: Addresa', NULL, '1', 1, NULL, 1, NULL, NULL, NULL, NULL, 9, 22, 35, 0, 0),
...
(10, 11, 'categories:id:pricelist', '3', 'Identikátor kategorie Ceník', 'Pricelist category identifier', '', 1),
...
(13, 11, 'categories:id:link', '4', 'Identikátor kategorie Odkazy', 'Link category identifier', '', 1),
...
(17, 11, 'categories:id:contactsPickups', '16', 'Identifik?tor kategorie m?st k vyzvednut?', 'Category identifier for pickup places', '', 1),
(18, 11, 'categories:id:mediaGallery', '6', 'Identikátor kategorie Media: Galerie', 'Media:Gallery category identifier', '', 1),
(19, 11, 'categories:id:mediaDocs', '8', 'Identikátor kategorie Media: Dokumenty', 'Media:Documents category identifier', '', 1),
...
(27, 16, 'members:groups:enabled', '0', 'Vytvářet uživatelské skupiny', 'Create user groups', 'boolean', 1),
...
(31, 12, 'members:signup:confirmByAdmin', '1', 'Registrace uživatele musí být potvrzena administr?torem.', 'User Registration must be confirmed by the admin.', 'boolean', 1),
...
(53, 13, 'store:currency:symbol', 'K?', 'Symbol měny', 'Currency symbol', NULL, 1),
(54, 13, 'store:stock:amountDefault', '10', 'P?ednastaven? mno?stv? polo?ek na skladu', 'Preset amount of items in stock', 'boolean', 0),
...
(64, 12, 'members_username_sa_email', '0', 'Použít e-mail jako uživatelské jméno', 'Use e-mail as username', 'boolean', 1),
...
ALTER TABLE `contacts`
  ...
  ADD CONSTRAINT `contacts_ibfk_5` FOREIGN KEY (`contacts_categories_id`) REFERENCES `settings_categories` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
