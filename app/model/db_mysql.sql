...
INSERT INTO `contacts_categories` (`id`, `parent_id`, `description`, `title`) VALUES
                                                                                               (1, NULL, '', 'Členové'),
                                                                                               (2, NULL, NULL, 'Kontakty na stránce'),
                                                                                               (3, NULL, NULL, 'Newsletter'),
                                                                                               (4, NULL, NULL, 'Proč další');
...
(4, 'Odeslání hesla pro existujícího uživatele', 'Tímto formulářem bude existujícímu uživateli odesláno nové heslo. Pozor. Pokaždé, když formulář odešlete, bude heslo změněno a odesláno.', 0, NULL, 'Vytvoření nového hesla', '                    <br /><br />                    Bylo Vám vytvořeno nové heslo. Zde jsou údaje nutné k přihlášení                    <br /><br />                    uživatelské jméno: {$username}<br />                    heslo: {$password}<br />                    <br /><br />                    Přihlašte se: <a href=\"{$settings[\'site:url:base\']}/sign/in\">{$settings[\'site:url:base\']}/sign/in</a>', 1, NULL, 0),
(5, 'Vytvoření účtu z administrace', 'Vytvoření nového uživatelského účtu z administrace', 0, NULL, 'Nový e-mail', '                    Your account was successfully created. You can now log in.                    <br /><br />                    user name: {$username}<br />                    password: {$password}<br />                    <br /><br />                    Log in: <a href=\"{$settings[\'site:url:base\']}/admin\">{$settings[\'site:url:base\']}/admin</a>', 1, NULL, 0),
(6, 'Zapomenuté heslo: administrace', 'Odeslání zapomenutého hesla pro členy administrace', 0, NULL, 'Informace o novém hesle', 'Na základě Vaší žádosti Vám posíláme odkaz na obnovení hesla.<br /><br />K vytvoření nového hesla klikněte na odkaz níže:<br /><a href=\"{$settings[\'site:url:base\']}/admin/sign/resetpass/?code={$code}&email={$email}\">    {$settings[\'site:url:base\']}/admin/sign/resetpass/?code={$code}&email={$email}</a><br /><br /><strong><a href=\"{$settings[\'site:url:base\']}\">{$settings[\'site:title\']}</a></strong>', 1, NULL, 0);
